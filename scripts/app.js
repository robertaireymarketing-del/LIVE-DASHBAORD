...
function renderBottomNav() {
  ...
  <nav class="bottom-nav-app">
    ...
    <button class="bottom-nav-app-btn ${state.activeTab==='planner'?'active':''}" onclick="setTab('planner')">✏️ Planner</button>
    <button class="bottom-nav-app-btn ${state.activeTab==='progress'?'active':''}" onclick="setTab('progress')">❤️ Health</button>
