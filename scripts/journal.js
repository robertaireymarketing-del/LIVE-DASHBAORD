export function initJournalTab(deps) {
  ...
  // ── 52 Stoic Principles (one per week of the year) ────────────────────
  const STOIC_PRINCIPLES = [
    ...
    { name:'NEGATIVE VISUALISATION', meaning:'Appreciate What You Have By Imagining Its Loss', quote:'He robs present ills of their power who has perceived their coming beforehand.', attr:'Seneca', application:'Imagine TJM never launches. Imagine the shop gone, the routine broken, the life with Warda delayed by years of inaction. Feel the weight of that — then let it push you through today with everything you have.' },
    { name:'THE RESERVE CLAUSE', meaning:'Plan Fully, Hold Loosely', quote:'I will sail across the ocean, if nothing prevents me.', attr:'Epictetus', application:'Plan the week\'s content, set the targets, execute the deep work blocks — but hold every outcome with an open hand. Commit fully to the effort. Release the result entirely. That is the reserve clause.' },
    { name:'IMPERMANENCE', meaning:'Nothing Lasts — Not Even the Hard Parts', quote:'Loss is nothing else but change, and change is Nature\'s delight.', attr:'Marcus Aurelius', application:'The slow weeks, the creative blocks, the frustrating days in the shop — they are passing. So is the good. Neither lasts. Which means now, in this moment, is where everything actually lives.' },
    { name:'GRATITUDE', meaning:'What You Have is Enough to Begin', quote:'Do not spoil what you have by desiring what you have not; remember that what you now have was once among the things you only hoped for.', attr:'Epicurus', application:'You have a craft, a platform, a family, a woman who believes in you, and a vision clear enough to act on. That is not a starting point. That is already everything. Use it.' },
    { name:'LOGOS', meaning:'Align With Reason, Not Emotion', quote:'If you are distressed by anything external, the pain is not due to the thing itself but your interpretation of it.', attr:'Marcus Aurelius', application:'When a video flops, when the numbers disappoint, when a day in the shop grinds — your feelings about it are your choice. The facts are neutral. Respond to the facts. Let reason lead.' },
    { name:'SILENCE AS STRENGTH', meaning:'The Man Who Talks Less Does More', quote:'Better to remain silent and be thought a fool than to speak and remove all doubt.', attr:'Epictetus', application:'Less justifying. Less explaining the plan to people who don\'t need to know. Less noise online about what you\'re going to do. More execution. TJM is built in silence and revealed in results.' },
    { name:'LEGACY', meaning:'What Will Outlast You?', quote:'A good character is the only guarantee of everlasting, carefree happiness.', attr:'Seneca', application:'The business, the brand, the values you build TJM on — these will outlast the metrics of any single week. Build something your family will be proud of. Build it today like it\'s going in the history books.' },
    { name:'DETACHMENT FROM OUTCOMES', meaning:'Give Everything, Need Nothing Back', quote:'Seek not that the things which happen should happen as you wish; but wish the things which happen to be as they are, and you will have a tranquil flow of life.', attr:'Epictetus', application:'Pour your absolute best into today\'s content, today\'s calls, today\'s work — and then genuinely let go. The need for a specific outcome is the source of almost all your friction. Release it.' },
    { name:'INTENTIONALITY', meaning:'Every Action Chosen, Never Drifted Into', quote:'Let all your efforts be directed to something, let it keep that end in view.', attr:'Seneca', application:'Not a single hour today should happen by accident. Every block of time is a decision. The gym, the content, the deep work, the treadmill block — chosen, not fallen into. That\'s the difference between building and drifting.' },
    { name:'PATIENCE', meaning:'Urgency and Stillness at Once', quote:'Bear patiently with a great affliction any one who has not the endurance of a great ill.', attr:'Epictetus', application:'TJM will not be built in a week. The body will not transform in a month. The compounding you\'re after requires patience as fierce as your ambition. Be urgent in your effort. Be patient with your timeline.' },
    { name:'FOCUS', meaning:'One Thing at Full Power', quote:'To be everywhere is to be nowhere.', attr:'Seneca', application:'Split attention is the enemy of everything you\'re building. One priority for the session. One camera angle, one hook, one objective at a time. The man who focuses completely on one thing is the most dangerous man in the room.' },
    { name:'RESILIENCE', meaning:'The Return is the Practice', quote:'A gem cannot be polished without friction, nor a man perfected without trials.', attr:'Seneca', application:'You\'ve already come back from a dormant account, from slow months, from hard days in the shop. That return is not a detour from the story — it is the story. The resilience is the brand. Keep going.' },
    { name:'HONESTY', meaning:'The Truth is the Foundation', quote:'If you would not have a man flinch when the crisis comes, train him before it comes.', attr:'Seneca', application:'Be brutally honest in this journal about what worked, what didn\'t, and why. Honest review of last week\'s content, honest numbers, honest effort. The man who can\'t face the truth can\'t change the result.' },
    { name:'LEADERSHIP', meaning:'Lead Yourself Before Anyone Else', quote:'He who has never learned to obey cannot be a good commander.', attr:'Aristotle', application:'TJM will one day have a team. Your VA is already watching the standard you set. The man you\'re becoming in private — in the 5am starts, the gym, the discipline — is the leader that brand will eventually require.' },
    { name:'COSMOPOLITANISM', meaning:'Think Beyond Your Immediate World', quote:'I am a citizen of the world.', attr:'Diogenes', application:'TJM isn\'t a Nottingham brand. It isn\'t a UK brand. The internet is global and your 30+ years of jewellery knowledge is valuable to someone in Sydney, Singapore, and São Paulo. Think at that scale. Create at that scale.' },
    { name:'THE PRESENT MOMENT', meaning:'This Is the Only Place Power Lives', quote:'Never let the future disturb you. You will meet it, if you have to, with the same weapons of reason which today arm you against the present.', attr:'Marcus Aurelius', application:'The version of TJM in five years doesn\'t need you right now. The anxiety about the shop lease doesn\'t need you right now. Right now needs you right now. This hour. This task. This standard.' },
    { name:'IDENTITY', meaning:'Become the Man First', quote:'First say to yourself what you would be; and then do what you have to do.', attr:'Epictetus', application:'You are not trying to build a jewellery brand. You are a man who builds things with excellence. You are not trying to get fit. You are a man who honours his body. Lead with the identity. The outcomes are just evidence.' },
    { name:'GENEROSITY', meaning:'Give Without Keeping Score', quote:'We are all of us fellow sufferers. Whatever afflicts you afflicts me.', attr:'Seneca', application:'Pour your real knowledge into TJM\'s content. Don\'t hold back your best insights for some imagined premium product. The man who gives the most value most freely builds the most loyal audience. Be generous with what you know.' },
    { name:'CONSISTENCY', meaning:'The Unsexy Superpower', quote:'Luck is what happens when preparation meets opportunity.', attr:'Seneca', application:'One more video this week, one more session, one more journal entry — none of them feel significant. All of them are. The difference between TJM\'s trajectory and mediocrity is not talent. It is consistency compounding over time.' },
    { name:'THE EXAMINED RELATIONSHIP', meaning:'Love as a Practice, Not a Feeling', quote:'What is the best a man can do? To enjoy good-will of as many men as possible.', attr:'Epictetus', application:'Warda is not a reward you\'ll collect when TJM succeeds. She is part of the life you\'re building right now. Show up for her with the same presence you bring to your best days of work. That relationship is also a daily practice.' },
    { name:'PURPOSE', meaning:'Know Why Before You Know How', quote:'He who has a why to live can bear almost any how.', attr:'Friedrich Nietzsche', application:'On the days the camera feels heavy, the shop feels slow, and the body is tired — come back to why. Financial independence. Freedom. A life built entirely on your own terms with Warda. That why can carry any how.' },
    { name:'ENDURANCE', meaning:'Stay the Course When It Gets Hard', quote:'Endure and renounce.', attr:'Epictetus', application:'The content grind, the rebuild, the physical cut — none of it is supposed to feel easy. The ones who build great things are not those who found it easy. They are those who stayed when it was hard. Stay.' },
  ];
  ...
  function getDayPrinciple() {
    ...
    return STOIC_PRINCIPLES[weekOfYear % STOIC_PRINCIPLES.length];
  }
